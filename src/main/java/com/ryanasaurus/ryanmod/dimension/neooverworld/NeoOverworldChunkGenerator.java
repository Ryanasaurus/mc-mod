...
public class NeoOverworldChunkGenerator extends ChunkGenerator<NeoOverworldChunkGenerator.Config> {

    public NeoOverworldChunkGenerator(IWorld world, BiomeProvider provider) {
